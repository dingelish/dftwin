...
// Registers
#define LIB_REG_EAX REGISTER_EAX
#define LIB_REG_AX LIB_REG_EAX
#define LIB_REG_AL LIB_REG_EAX
#define LIB_REG_ES LIB_REG_EAX          // Just for reg_table consistence
#define LIB_REG_ST0 LIB_REG_EAX         // Just for reg_table consistence
#define LIB_REG_ECX REGISTER_ECX
#define LIB_REG_CX LIB_REG_ECX
#define LIB_REG_CL LIB_REG_ECX
#define LIB_REG_CS LIB_REG_ECX
#define LIB_REG_ST1 LIB_REG_ECX
#define LIB_REG_EDX REGISTER_EDX
#define LIB_REG_DX LIB_REG_EDX
#define LIB_REG_DL LIB_REG_EDX
#define LIB_REG_SS LIB_REG_EDX
#define LIB_REG_ST2 LIB_REG_EDX
#define LIB_REG_EBX REGISTER_EBX
#define LIB_REG_BX LIB_REG_EBX
#define LIB_REG_BL LIB_REG_EBX
#define LIB_REG_DS LIB_REG_EBX
#define LIB_REG_ST3 LIB_REG_EBX
#define LIB_REG_ESP REGISTER_ESP
#define LIB_REG_SP LIB_REG_ESP
#define LIB_REG_AH LIB_REG_ESP          // Just for reg_table consistence
#define LIB_REG_FS LIB_REG_ESP
#define LIB_REG_ST4 LIB_REG_ESP
#define LIB_REG_EBP REGISTER_EBP
#define LIB_REG_BP LIB_REG_EBP
#define LIB_REG_CH LIB_REG_EBP
#define LIB_REG_GS LIB_REG_EBP
#define LIB_REG_ST5 LIB_REG_EBP
#define LIB_REG_ESI REGISTER_ESI
#define LIB_REG_SI LIB_REG_ESI
#define LIB_REG_DH LIB_REG_ESI
#define LIB_REG_ST6 LIB_REG_ESI
#define LIB_REG_EDI REGISTER_EDI
#define LIB_REG_DI LIB_REG_EDI
#define LIB_REG_BH LIB_REG_EDI
#define LIB_REG_ST7 LIB_REG_EDI
#define LIB_REG_NOP REGISTER_NOP

// Implied operands
#define IOP_EAX		1
#define IOP_ECX		(1 << LIB_REG_ECX)
#define IOP_EDX		(1 << LIB_REG_EDX)
#define IOP_EBX		(1 << LIB_REG_EBX)
#define IOP_ESP		(1 << LIB_REG_ESP)
#define IOP_EBP		(1 << LIB_REG_EBP)
#define IOP_ESI		(1 << LIB_REG_ESI)
#define IOP_EDI		(1 << LIB_REG_EDI)
#define IOP_ALL		IOP_EAX|IOP_ECX|IOP_EDX|IOP_ESP|IOP_EBP|IOP_ESI|IOP_EDI
#define IS_IOP_REG(x,y)	(x >> y) & 1
#define IS_IOP_EAX(x)	(x) & 1
#define IS_IOP_ECX(x)	(x >> LIB_REG_ECX) & 1
#define IS_IOP_EDX(x)	(x >> LIB_REG_EDX) & 1
#define IS_IOP_EBX(x)	(x >> LIB_REG_EBX) & 1
#define IS_IOP_EBP(x)	(x >> LIB_REG_EBP) & 1
#define IS_IOP_ESI(x)	(x >> LIB_REG_ESI) & 1
#define IS_IOP_EDI(x)	(x >> LIB_REG_EDI) & 1
...
int testsc(const unsigned char* str, DWORD size);
// Operand flags
...
struct allop{
	OPERAND out[2];
	unsigned int out_addr[2];
	OPERAND in[3];
	unsigned int in_addr[3];
	unsigned int in_value[3];
	unsigned int extra_no;
	struct extra_para extra[0];
};
